...
FilterMin::FilterMin(const std::vector< std::pair<std::string, std::string> >& vecArgs, const std::string& name, const Config& cfg)
          : ProcessingBlock(vecArgs, name, cfg), min_val(0.), min_soft(0.), is_soft(false)
{
	parse_args(vecArgs);
