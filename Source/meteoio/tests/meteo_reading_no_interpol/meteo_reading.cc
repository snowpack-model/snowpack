...
const double res_Met_7 []	= {0.57,			0.95,				1.9,				1.41,				0.35,				0.72,				1.47}; // HS
const double res_Met_8 []	= {2.9,				0.6,				2.,					0.2,				2.5,				1.5,				0.3}; // VW
const double res_Met_9 []	= {335.,			138.,				98.,				216.,				268.,				187.,				107.}; // DW
...
const double res_Met_11 []	= {97.00,			93.00,				74.00,				55.00,				93.00,				101.00,				97.00}; //RSWR
...
const double res_Met_15 []	= {IOUtils::nodata,	IOUtils::nodata,	IOUtils::nodata,	4.,					5.160045665,		0.,					IOUtils::nodata}; // HNW
