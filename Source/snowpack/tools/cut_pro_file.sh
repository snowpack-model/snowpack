...
#
# Example 1: bash reduce_pro_file.sh -r 4 output/output.pro > output/cut_output.pro
#            this reduces the output to every 4th data frame, writing output to file: output/cut_output.pro.
# Example 2: bash reduce_pro_file.sh -r 4 -b 1980-01-01T00:00 output/output.pro
#            this reduces the output to every 4th data frame on and after 1980-01-01T00:00, writing output to stdout.
# Example 3: bash reduce_pro_file.sh -r 4 -e 1990-01-01T00:00 output/output.pro
...
function printHelp {
	...
	echo "" > /dev/stderr
	echo "Example 1: bash reduce_pro_file.sh -r 4 output/output.pro > output/cut_output.pro" > /dev/stderr
	echo "           this reduces the output to every 4th data frame, writing output to file: output/cut_output.pro." > /dev/stderr
	echo "Example 2: bash reduce_pro_file.sh -r 4 -b 1980-01-01T00:00 output/output.pro" > /dev/stderr
	echo "           this reduces the output to every 4th data frame on and after 1980-01-01T00:00, writing output to stdout." > /dev/stderr
	echo "Example 3: bash reduce_pro_file.sh -r 4 -e 1990-01-01T00:00 output/output.pro" > /dev/stderr
